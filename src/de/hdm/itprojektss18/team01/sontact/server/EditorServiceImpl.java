...
public class EditorServiceImpl extends RemoteServiceServlet implements EditorService {
	...
	public void createAuspraegungForNewEigenschaft(String bezeichnung, String wert, Kontakt k)
		...
		//Es wird eine EIgenschaft erstellt und dieser wird die EigenschaftsId übermittelt.
	...
	/**
	 * Auslesen aller Kontakt, bei diesen der Nutzer als Eigent�mer hinterlegt ist, sowie 
	...
	public Vector<Nutzer> sharedWith(int objectId, char type, Nutzer n) throws IllegalArgumentException {
		...
		// Leerer Vektor fuer Nutzerobjekten mit welchen die �bergebene objectId geteilt wurde
	...
	/**
	 * Auslesen einer Eigenschaft anhand der �bergebenen Bezeichnung.
	 */
	 ...
	 * Sucheingabe, wird das aufgerufene Objekt zur�ckgeben.
	 * 
	 * @param listBoxWert,
	 *            testBoxWert
	 * @param n
