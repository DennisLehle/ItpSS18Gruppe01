...
public class EditorServiceImpl extends RemoteServiceServlet implements EditorService{
	...
	public void deleteNutzer(Kontakt k) throws IllegalArgumentException {
		...
		// L�schen der Berechtigungsstufe muss berr�cksichtigt werden.
		...
		//Wie werden Eigenschaften ber�cksichtigt beim L�schen?		
		this.kMapper.deleteAll(k);
				
		this.klMapper.deleteAll(k.getOwnerId());
		
		//�bergabe des CurrentUsers
