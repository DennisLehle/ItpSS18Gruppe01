...
public class EditorServiceImpl extends RemoteServiceServlet implements EditorService {
	 ...
	 */
	/**
	 * Wie l�sen wir das mit den �bergabeparameter f�r Kontakt,
	 * Kontaktliste oder Auspr�gung? M�ssen diese �berhaupt �bergeben
	 * werden?
	 * 
	 * @param holderId
	 * @param receiverId
	...
	//Owner l�scht ein berechtigtes Objekt und somit die Berechtigungen des Objekts
	...
	//Teilhaber l�scht ein berechtigtes Objekt und somit die Berechtigungen 
...
/**	
 ...
 /**
	...
	public void createStatusForKontakt( int ownerId, int receiverId) throws IllegalArgumentException {
		//IstUser Teilhaber oder Eigent�mer
